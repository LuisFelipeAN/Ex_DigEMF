...
public interface FilesystemPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Atalhos</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FILESYSTEM__ATALHOS = 3;
	 ...
	 * @ordered
	 */
	int FILESYSTEM_FEATURE_COUNT = 6;
	 ...
	 * @ordered
	 */
	int FOLDER__NOME = FILE_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link filesystem.Filesystem#getAtalhos <em>Atalhos</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Atalhos</em>'.
	 * @see filesystem.Filesystem#getAtalhos()
	 * @see #getFilesystem()
	 * @generated
	 */
	EReference getFilesystem_Atalhos();
	...
	/**
	 * Returns the meta object for the attribute '{@link filesystem.Filesystem#getAutoID <em>Auto ID</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Auto ID</em>'.
	 * @see filesystem.Filesystem#getAutoID()
	 * @see #getFilesystem()
	 * @generated
	 */
	EAttribute getFilesystem_AutoID();
	...
	/**
	 * Returns the meta object for the attribute '{@link filesystem.Folder#getNome <em>Nome</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Nome</em>'.
	 * @see filesystem.Folder#getNome()
	 * @see #getFolder()
	 * @generated
	 */
	EAttribute getFolder_Nome();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Atalhos</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference FILESYSTEM__ATALHOS = eINSTANCE.getFilesystem_Atalhos();
		 ...
		 * @generated
		 */
		EAttribute FILESYSTEM__AUTO_ID = eINSTANCE.getFilesystem_AutoID();
		 ...
		 * @generated
		 */
		EAttribute FOLDER__NOME = eINSTANCE.getFolder_Nome();
