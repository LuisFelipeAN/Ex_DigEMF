...
public class FilesystemPackageImpl extends EPackageImpl implements FilesystemPackage {
	 ...
	 * @generated
	 */
	public EReference getFilesystem_Atalhos() {
	 ...
	 * @generated
	 */
	public EAttribute getFilesystem_AutoID() {
		return (EAttribute)filesystemEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getFolder_Nome() {
	...
	public void createPackageContents() {
		...
		createEReference(filesystemEClass, FILESYSTEM__ATALHOS);
		createEReference(filesystemEClass, FILESYSTEM__SYNCS);
		createEAttribute(filesystemEClass, FILESYSTEM__AUTO_ID);

		driveEClass = createEClass(DRIVE);

		folderEClass = createEClass(FOLDER);
		createEAttribute(folderEClass, FOLDER__NOME);
	...
	public void initializePackageContents() {
		...
		initEReference(getFilesystem_Atalhos(), this.getShortcut(), null, "atalhos", null, 0, -1, Filesystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFilesystem_AutoID(), ecorePackage.getEBooleanObject(), "autoID", "true", 0, 1, Filesystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(driveEClass, Drive.class, "Drive", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(folderEClass, Folder.class, "Folder", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFolder_Nome(), ecorePackage.getEString(), "nome", null, 0, 1, Folder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createGmf_1Annotations() {
		...
		addAnnotation
		  (driveEClass, 
		   source, 
		   new String[] {
			 "figure", "figuras.Drive"
		   });	
		addAnnotation
		  (folderEClass, 
		   source, 
		   new String[] {
			 "figure", "figuras.Pasta"
		   });	
		addAnnotation
		  (fileEClass, 
		   source, 
